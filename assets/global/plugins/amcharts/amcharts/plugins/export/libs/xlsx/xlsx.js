...
function parse_(blob, length) {
    var dwVersion = blob.read_shift(4);
    if(dwVersion === 124226) return;
    blob.l += length-4;
}

/* 2.5.49 */
function parse_Color(blob, length) { return blob.read_shift(4); }
...
function parse_FullColorExt(blob, length) {
    ...
    switch(o.xclrType) {
        ...
        case 3: o.xclrValue = parse_Color(blob, 4); break;
...
function parse_BrtWbProp(data, length) {
    data.read_shift(4);
    var dwVersion = data.read_shift(4);
    var strName = (length > 8) ? parse_XLWideString(data) : "";
    return [dwVersion, strName];
}
